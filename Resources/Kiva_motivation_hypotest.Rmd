...
ORDER BARS BY FUNDED LOAN RATE, PUT THIS IN AES INSTEAD OF SECTOR: reorder(sector, prop)
...
OUTLINE THE BASIC STEPS OF A HYPOTHESIS TEST AND DEFINE YOUR DECISION RULE AND WHAT A P-VALUE IS HERE.
...
FORMATTING MESSED UP HERE, FIX LATEX, NO NEED FOR TEXTT IN YOUR DESCRIPTION
...
WRITE IT OUT SYMBOLICALLY, LOOKS LIKE A TYPO
...
TYPICALLY THE LOWEST P-VALUE USED IS 0.001, SO YOU SHOULD SAY P \< 0.001 NOT P\<0.05.
...
DON'T COPY AND PASTE YOUR TEXT FOR EACH HYPOTHESIS TEST! EXPLAIN THE FORMAT OF A HYPOTHESIS TEST AT THE BEGINNING OF THE SECTION SO YOU DON'T HAVE TO REPEAT THIS. THEN UNDER EACH TEST, SAY SOMETHING LIKE: THE ONE SIDED T-TEST RESULTS IN A P-VALUE LESS THAN 0.001 AND SO WE REJECT THE NULL HYPOTHESIS. THUS, WE FIND STRONG EVIDENCE THAT FEMALE BORROWERS ON AVERAGE RECEIVE HIGHER VALUE LOANS. THIS INDICATES A POTENTIAL PREFERENCE OF LENDERS FOR FEMALE BORROWERS. WE COULD INTERPRET THIS AS EVIDENCE THAT LENDERS ARE MOTIVATE BY A DESIRE TO IMPROVE THE POSITION OF WOMEN IN DEVELOPING COUNTRIES - NOT CONCLUSIVE, BUT SUGGESTS AVENUES FOR FUTURE RESEARCH.
...
To conclude, through descriptive statistics we observed that highest proportion of Funded Loans are in the Health, Education and Wholesale sector to name a few. Based on our data, we have seen that the proportion of funded loans is higher than not funded loans, which reflects the high funding rate for all sectors. We see that female borrowers received the highest over all loan amounts throughout 2005-2012. (However, we must keep in mind that our data contains more female borrowers). We also looked at the average amount given to borrowers across sectors and noted that group borrowers tend to received the lowest average loan amount in funded loans. Through our hypothesis test we learned that the average loan amount received by a borrower does not differ based on the borrower's gender. Further we also observed that proportion of funded loans for female borrowers is higher than male borrowes.
