...
Before we visualize the data, we first need to add an indicator for borrower type and funding status to our data set. This will help improve our visualizations and communicate trends at these two levels.
