...
IT SEEMS WEIRD TO HAVE ONLY ONE PLOT IN THIS SECTION WHEN YOU HAVE MULTIPLE FOR LENDER MOTIVATION. HERE'S THE BASIC CODE FOR A SIDE BY SIDE BAR GRAPH WHICH WILL ALLOW YOU TO COMMENT THE DEFAULT RATE IS GENERALLY VERY LOW, AND NOTE SECTORS WHERE WOMEN HAVE A LOWER DEFAULT RATE THAN MEN (E.G. MANUFACTURING AND HOUSING), HIGHER, SIMILAR...

ALSO NOTE THAT THE DEFAULT RATE IS IDENTICALLY ZERO IN SOME SECTORS FOR SOME GENDERS

YOU CAN EXPERIMENT WITH SORTING THE BARS DIFFERENTLY. CURRENTLY I JUST LOOK AT THE TOP TEN SECTORS BUT YOU CAN CHANGE THAT BY REMOVING THE SUBSETTING IN loans_temp[1:10, ]
...
left_join(loans_temp[1:10, ], loans_df,  by = "sector") %>%
